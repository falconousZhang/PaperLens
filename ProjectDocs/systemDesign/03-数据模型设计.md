...
| checkpoint_type | VARCHAR(20) | | 统计口径 |
...
**checkpoint_source 枚举**：
- `EXPLICIT_TEXT`: 显式文本标注
- `IMPLICIT_CONTEXT`: 隐式上下文推断
- `TABLE_HEADER`: 表格标题推断
- `UNKNOWN`: 未知

#### ExperimentFile (实验数据文件表)
